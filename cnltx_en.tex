...
\begin{commands}
  \command{newname}[\marg{cs}\marg{first name}\marg{last name}]
  ...
  \command{name}[\sarg\oarg{first name}\marg{last name}]
    \sinceversion{0.11}Typesets a name according to the same specs as the
...
Others can be added and the existing ones changed with the following commands
