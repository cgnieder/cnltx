...
\begin{itemize}
  ...
  \item In case parts of this bundle prove useful to be used in a document the
    ...
    modules can be given as package option.
    \begin{sourcecode}[gobble=6]
...
\begin{options}
  \keyval{max-pages}{number}\Default{4}
    The maximum number of pages in a row.  The pages width is scaled to
...
\begin{commands}
  ...
  \expandable\command{cnltx\at ifshellescape}[\marg{true}\marg{false}]
    ...
    \pkg{pdftexcmds}' \cs*{pdf@shellescape} has the value \code{1}.
