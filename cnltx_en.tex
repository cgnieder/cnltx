...
this:
\begin{options}
  \keyval{expandable-sign}{definition}\Default{\cs*{raise}-.5ex\cs*{hbox}\Marg{*}}
...
can find them in \file{cnltx-listings.sty} or in
...
as ``silent'' names by \cnltx, that is, those defined by \cnltxlistings.  You
