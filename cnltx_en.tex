...
\begin{itemize}
  \item \cnltxbase\ -- defines base macros for error-messaging and expansion
    control.  It also provides color definitions and defines a few color
    schemes for the \cnltxdoc\ class.  All other packages and classes of the
    bundle load this package.
...
\begin{commands}
  ...
  \command{indexcs}
    ...
    by listings.  Used to index commands in the \env{sourcecode} and
